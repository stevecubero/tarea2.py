...
def depositos (x,y,z): #Funcion encargada de procesar depositos
    ...
    return (x,y,z)
    #print ("La cantidad a depositar total es de: ", x)
    #print ("La cantidad de depositos del dia fue de: ", y)
    #print ("La cantidad total en retiros fue de", z)
...
def retiros (x,y,z): #Funcion encargada de procesar retiros
    ...
    return (x,y,z)
    #print ("La cantidad a retirar total es de: ", x)
    #print ("La cantidad de retiros del dia fue de: ", y)
    #print ("La cantidad total en retiros fue de", z)
